...
However, we must rotate this vector about the $X$ axis by an unknown amount $\gamma$ in order
...
Then $\gamma$, the amount we need to rotate, is the angle need
to rotate the plane so that it intersects the $z$ axis at $I_z$.
By basic geometry of similar triangles,
this is computed from the right triangle of the origin, $h$, and $I_z$.
