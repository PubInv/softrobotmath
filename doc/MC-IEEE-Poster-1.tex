...
\usecolorstyle[colorPalette=Default]{Default}
 ...
 \begin{columns}
     \column{0.5}
     \block{Screenshot of Online Calculator: \url{https://pubinv.github.io/softrobotmath/}\cite{softrobotcalc}}{
       \includegraphics[width=0.40\textwidth]{figures/StandardThreeSphereDiagram.png}
     }
     \column{0.5}
     \block{Mechanical Stewart Platform}{
       \begin{tikzfigure}[Stewart Platform]
         \includegraphics[width=0.24\textwidth]{figures/Hexapod_general.jpg}
       \end{tikzfigure}
     }
...
\begin{align}
  ...
  \theta  &= \arccos{\frac{(r_2+r_3)^2 + (r_1+r_3)^2 - (r_1+r_2)^2}
    {2(r_1+r_3)(r_1+r_2)}} \\
\end{align}
